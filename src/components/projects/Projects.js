			...
			<React.Fragment>
				...
				{/* {projects.map(project => ( */}
					...
					>
						...
						>
							<div key={projects.id} className={this.props.projectsCardClass}>
								<div className="cardProject--Img">
									<img
										onClick={this.changePageFromProjects.bind(this, [
											projects.covers.max_808,
											projects.name,
											projects.owners[0].username,
											projects.stats.views,
											projects.stats.appreciations,
											projects.stats.comments,
											projects.fields[0],
											projects.fields[1],
											projects.fields[2]
										])}
										className="designerProject--Img"
										src={projects.covers["max_808"]}
										onError={e => {
								...
								<div className="wrapperProject--Details">
									<div className="wrapper paraStyle--DesignerProject">
										<p className={this.props.projectsPClass}>{projects.name}</p>
										<p className={this.props.projectsCaptionClass}>
											Views: {projects.stats.views}
										</p>
									</div>
								</div>
							</div>

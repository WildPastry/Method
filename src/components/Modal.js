	...
	render() {
					...
					<div className="row bgLightPink textDark methodModal__bottom">
						...
						<div className="col-4 methodModal__bottomLeft">
							...
							<h5 className="textThin methodModal__bottomLeft--text">
								Views:{" "}
								{this.props.modalState[projectDeets].projects[0].stats.views}
							</h5>
						</div>
		...
		C65.2,29.8,65.4,31.9,64.8,34.7z"
							...
							<h5 className="textThin methodModal__bottomMiddle--text">
								Likes:{" "}
								{
									this.props.modalState[projectDeets].projects[0].stats
										.appreciations
								}
							</h5>
						</div>
						<div className="col-4 methodModal__bottomRight">
							...
							<h5 className="textThin methodModal__bottomRight--text">
								Comments:{" "}
								{this.props.modalState[projectDeets].projects[0].stats.comments}
							</h5>
						</div>
						<div className="col-12 methodModal__bannerBottom">
							<p className="textThin methodModal__bannerBottom--text">
								{this.props.modalState[projectDeets].projects[0].fields[0]} |{" "}
								{this.props.modalState[projectDeets].projects[0].fields[1]} |{" "}
								{this.props.modalState[projectDeets].projects[0].fields[2]}
							</p>
						</div>
					</div>
				</div>
